...
const handelRegister = () =>{
  ...
  return (
    ...
    <div  ame="relative py-3 sm:max-w-xl sm:mx-auto">
      <div
...
{error? <p className='text-red-600 text-base'>Email or password is incorrect:</p>  : ""}
          ...
          <div className='flex w-full items-center flex-col mt-5 gap-5'>
            <button onClick={handelRegister} className='block'> <img src={googleLogo} alt=""  className='w-12 h-12 inline-block'/>Login with Google</button>
          </div>
        </div>
      </div>
    </div>
